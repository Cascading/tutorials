...
public class TransactionWrapperBinding extends CArrayComplexBinding
  {

  /**
   * Value object to which this cobol complex array element is bound.
   */
  private List<Transaction> mValueObject;
   ...
   */
  public TransactionWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Transaction.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 0 );
    setMaxOccurs( 5 );
    setDependingOn( "TRANSACTION-NBR" );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Transaction>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Transaction >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Transaction) getComplexItemBinding().
      getObjectValue( Transaction.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Transaction>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Transaction.class ) )
        {
        mValueObject = (List<Transaction>) value;
        return;
        }
      }
   ...
   * @throws com.legstar.coxb.host.HostException if bound value object cannot be retrieved
   */
  @SuppressWarnings("unchecked")
  public List<Transaction> getTransaction() throws HostException
    {
    return (List<Transaction>) getObjectValue( Transaction.class );
    }
