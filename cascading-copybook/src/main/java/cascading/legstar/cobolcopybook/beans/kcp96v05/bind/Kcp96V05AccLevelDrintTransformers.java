package cascading.legstar.cobolcopybook.beans.kcp96v05.bind;
...
public class Kcp96V05AccLevelDrintTransformers extends AbstractTransformers
  ...
  public Kcp96V05AccLevelDrintTransformers()
    {
    super( new Kcp96V05AccLevelDrintJavaToHostTransformer(),
      new Kcp96V05AccLevelDrintHostToJavaTransformer() );
    }
   ...
   */
  public Kcp96V05AccLevelDrint toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp96V05AccLevelDrint toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp96V05AccLevelDrint toJava( final byte[] hostData, final int offset,
