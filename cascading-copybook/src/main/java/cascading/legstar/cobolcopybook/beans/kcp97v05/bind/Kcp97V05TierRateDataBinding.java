 ...
 */
public class Kcp97V05TierRateDataBinding
   ...
   */
  public Kcp97V05TierRateDataBinding(
    final Kcp97V05TierRateData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp97V05RateTierNumber = BF.createPackedDecimalBinding( "Kcp97V05RateTierNumber",
      "Kcp97V05RateTierNumber", Short.class, this );
    ...
    _kcp97V05XsRateChangeInd = BF.createStringBinding( "Kcp97V05XsRateChangeInd",
      "Kcp97V05XsRateChangeInd", String.class, this );
    _kcp97V05XsRateChangeInd.setCobolName( "KCP97V05-XS-RATE-CHANGE-IND" );
    _kcp97V05XsRateChangeInd.setByteLength( 1 );
    _kcp97V05NoOfChanges = BF.createPackedDecimalBinding( "Kcp97V05NoOfChanges",
      "Kcp97V05NoOfChanges", Short.class, this );
    ...
    _kcp97V05HistoricalRateDataWrapperItem = new Kcp97V05HistoricalRateDataBinding( "Kcp97V05HistoricalRateDataWrapperItem",
      "Kcp97V05HistoricalRateData", this, null );
    _kcp97V05HistoricalRateDataWrapper = new Kcp97V05HistoricalRateDataWrapperBinding( "Kcp97V05HistoricalRateDataWrapper",
      "Kcp97V05HistoricalRateData", this, _kcp97V05HistoricalRateDataWrapperItem );
    ...
    _kcp97V05DefaultRateT006Key = BF.createStringBinding( "Kcp97V05DefaultRateT006Key",
      "Kcp97V05DefaultRateT006Key", String.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp97V05RateTierNumber"
        + " value=" + mValueObject.getKcp97V05RateTierNumber() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp97V05XsRateChangeInd"
        + " value=" + mValueObject.getKcp97V05XsRateChangeInd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp97V05NoOfChanges"
        + " value=" + mValueObject.getKcp97V05NoOfChanges() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp97V05HistoricalRateDataWrapper"
        + " value=" + mValueObject.getKcp97V05HistoricalRateData() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp97V05DefaultRateT006Key"
        + " value=" + mValueObject.getKcp97V05DefaultRateT006Key() );
      }
