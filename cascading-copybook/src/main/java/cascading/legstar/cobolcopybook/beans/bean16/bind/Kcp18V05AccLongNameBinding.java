 ...
 */
public class Kcp18V05AccLongNameBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp18V05AccLongNameBinding( final Kcp18V05AccLongName valueObject )
    {
   ...
   */
  public Kcp18V05AccLongNameBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp18V05AccLongName valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp18V05LongNameData = new Kcp18V05LongNameDataBinding( "Kcp18V05LongNameData", "Kcp18V05LongNameData", this, null );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LongNameData" + " value=" + mValueObject.getKcp18V05LongNameData() );
      }
