 ...
 * generated in the cascading.legstar.cobolcopybook.beans.kc3ogp06 package.
...
public class ObjectFactory
  ...
  private final static QName _Ogp06ReferralData_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/kc3ogp06", "ogp06ReferralData" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.kc3ogp06
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/kc3ogp06", name = "ogp06ReferralData")
