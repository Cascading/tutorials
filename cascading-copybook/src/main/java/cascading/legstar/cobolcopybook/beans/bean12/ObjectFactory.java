 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean12 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp09V05OtherLimits_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean12", "kcp09V05OtherLimits" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean12
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean12", name = "kcp09V05OtherLimits")
