...
@XmlType(name = "Kcp93V05HistoricalTierData", propOrder = {"kcp93V05LimitEffectiveDate", "kcp93V05TierUpperLimit"})
public class Kcp93V05HistoricalTierData implements Serializable
  {
