 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean16 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp18V05AccLongName_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean16", "kcp18V05AccLongName" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean16
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean16", name = "kcp18V05AccLongName")
