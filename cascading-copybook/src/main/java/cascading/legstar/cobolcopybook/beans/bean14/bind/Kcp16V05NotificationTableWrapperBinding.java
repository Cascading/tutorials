 ...
 * List < Kcp16V05NotificationTable >.
 * <p/>
...
public class Kcp16V05NotificationTableWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp16V05NotificationTable> mValueObject;
   ...
   */
  public Kcp16V05NotificationTableWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp16V05NotificationTable.class, null, parentBinding, complexItemBinding );
    setMinOccurs( -1 );
    setMaxOccurs( 10 );
    setDependingOn( "KCP16V05-NO-OF-NOTIFICATIONS" );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp16V05NotificationTable>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp16V05NotificationTable >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp16V05NotificationTable) getComplexItemBinding().
      getObjectValue( Kcp16V05NotificationTable.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp16V05NotificationTable>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp16V05NotificationTable.class ) )
        {
        mValueObject = (List<Kcp16V05NotificationTable>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp16V05NotificationTable> getKcp16V05NotificationTable() throws HostException
    {
    return (List<Kcp16V05NotificationTable>) getObjectValue( Kcp16V05NotificationTable.class );
    }
