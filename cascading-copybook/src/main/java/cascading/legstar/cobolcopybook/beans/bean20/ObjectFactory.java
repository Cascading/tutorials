 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean20 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp96V05AccLevelDrint_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean20", "kcp96V05AccLevelDrint" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean20
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean20", name = "kcp96V05AccLevelDrint")
