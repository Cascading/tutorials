 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean15 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp17V05AccAddresses_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean15", "kcp17V05AccAddresses" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean15
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean15", name = "kcp17V05AccAddresses")
