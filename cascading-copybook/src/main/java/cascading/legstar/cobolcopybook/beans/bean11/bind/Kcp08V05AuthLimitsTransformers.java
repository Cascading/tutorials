...
public class Kcp08V05AuthLimitsTransformers extends AbstractTransformers
  ...
  public Kcp08V05AuthLimitsTransformers()
    {
    super( new Kcp08V05AuthLimitsJavaToHostTransformer(),
      new Kcp08V05AuthLimitsHostToJavaTransformer() );
    }
   ...
   */
  public Kcp08V05AuthLimits toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp08V05AuthLimits toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp08V05AuthLimits toJava( final byte[] hostData, final int offset,
