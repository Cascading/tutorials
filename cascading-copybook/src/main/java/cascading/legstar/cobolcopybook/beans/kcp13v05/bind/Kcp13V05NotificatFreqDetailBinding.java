 ...
 */
public class Kcp13V05NotificatFreqDetailBinding
   ...
   */
  public Kcp13V05NotificatFreqDetailBinding(
    final Kcp13V05NotificatFreqDetail valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp13V05NotificatFreqCode = BF.createStringBinding( "Kcp13V05NotificatFreqCode",
      "Kcp13V05NotificatFreqCode", String.class, this );
    _kcp13V05NotificatFreqCode.setCobolName( "KCP13V05-NOTIFICAT-FREQ-CODE" );
    _kcp13V05NotificatFreqCode.setByteLength( 1 );
    _kcp13V05NotificatDayOfMnth = BF.createPackedDecimalBinding( "Kcp13V05NotificatDayOfMnth",
      "Kcp13V05NotificatDayOfMnth", Short.class, this );
    ...
    _kcp13V05NotificatDayOfWeek = BF.createArrayStringBinding( "Kcp13V05NotificatDayOfWeek",
      "Kcp13V05NotificatDayOfWeek", String.class, this );
    ...
    _kcp13V05NotificatDueDate = BF.createStringBinding( "Kcp13V05NotificatDueDate",
      "Kcp13V05NotificatDueDate", String.class, this );
    _kcp13V05NotificatDueDate.setCobolName( "KCP13V05-NOTIFICAT-DUE-DATE" );
    _kcp13V05NotificatDueDate.setByteLength( 2 );
    _kcp13V05NotificatRecurChg = BF.createPackedDecimalBinding( "Kcp13V05NotificatRecurChg",
      "Kcp13V05NotificatRecurChg", Short.class, this );
    ...
    _kcp13V05ReasonCode = BF.createPackedDecimalBinding( "Kcp13V05ReasonCode",
      "Kcp13V05ReasonCode", Short.class, this );
    ...
    _kcp13V05NotificatCommAction = BF.createPackedDecimalBinding( "Kcp13V05NotificatCommAction",
      "Kcp13V05NotificatCommAction", Short.class, this );
    ...
    _kcp13V05NotificatCrintActn = BF.createPackedDecimalBinding( "Kcp13V05NotificatCrintActn",
      "Kcp13V05NotificatCrintActn", Short.class, this );
    ...
    _kcp13V05NotificatDrintActn = BF.createPackedDecimalBinding( "Kcp13V05NotificatDrintActn",
      "Kcp13V05NotificatDrintActn", Short.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatFreqCode"
        + " value=" + mValueObject.getKcp13V05NotificatFreqCode() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatDayOfMnth"
        + " value=" + mValueObject.getKcp13V05NotificatDayOfMnth() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatDayOfWeek"
        + " value=" + mValueObject.getKcp13V05NotificatDayOfWeek() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatDueDate"
        + " value=" + mValueObject.getKcp13V05NotificatDueDate() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatRecurChg"
        + " value=" + mValueObject.getKcp13V05NotificatRecurChg() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05ReasonCode"
        + " value=" + mValueObject.getKcp13V05ReasonCode() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatCommAction"
        + " value=" + mValueObject.getKcp13V05NotificatCommAction() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatCrintActn"
        + " value=" + mValueObject.getKcp13V05NotificatCrintActn() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatDrintActn"
        + " value=" + mValueObject.getKcp13V05NotificatDrintActn() );
      }
