 ...
 * List < Kcp93V05HistoricalTierData >.
 * <p/>
...
public class Kcp93V05HistoricalTierDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp93V05HistoricalTierData> mValueObject;
   ...
   */
  public Kcp93V05HistoricalTierDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp93V05HistoricalTierData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 4 );
    setMaxOccurs( 4 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp93V05HistoricalTierData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp93V05HistoricalTierData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp93V05HistoricalTierData) getComplexItemBinding().
      getObjectValue( Kcp93V05HistoricalTierData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp93V05HistoricalTierData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp93V05HistoricalTierData.class ) )
        {
        mValueObject = (List<Kcp93V05HistoricalTierData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp93V05HistoricalTierData> getKcp93V05HistoricalTierData() throws HostException
    {
    return (List<Kcp93V05HistoricalTierData>) getObjectValue( Kcp93V05HistoricalTierData.class );
    }
