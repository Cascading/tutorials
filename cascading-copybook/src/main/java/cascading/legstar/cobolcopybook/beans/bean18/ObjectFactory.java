 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean18 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp93V05AccLevelCrint_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean18", "kcp93V05AccLevelCrint" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean18
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean18", name = "kcp93V05AccLevelCrint")
