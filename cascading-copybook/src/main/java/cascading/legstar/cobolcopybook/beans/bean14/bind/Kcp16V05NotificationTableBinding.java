 ...
 */
public class Kcp16V05NotificationTableBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp16V05NotificationTableBinding( final Kcp16V05NotificationTable valueObject )
    {
   ...
   */
  public Kcp16V05NotificationTableBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp16V05NotificationTable valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp16V05NotificatTypeCode = BF.createStringBinding( "Kcp16V05NotificatTypeCode", "Kcp16V05NotificatTypeCode", String.class, this );
    _kcp16V05NotificatTypeCode.setCobolName( "KCP16V05-NOTIFICAT-TYPE-CODE" );
    _kcp16V05NotificatTypeCode.setByteLength( 1 );
    _kcp16V05NotificatSubTypeCd = BF.createStringBinding( "Kcp16V05NotificatSubTypeCd", "Kcp16V05NotificatSubTypeCd", String.class, this );
    _kcp16V05NotificatSubTypeCd.setCobolName( "KCP16V05-NOTIFICAT-SUB-TYPE-CD" );
    _kcp16V05NotificatSubTypeCd.setByteLength( 1 );
    _kcp16V05NotificationProdDat = BF.createStringBinding( "Kcp16V05NotificationProdDat", "Kcp16V05NotificationProdDat", String.class, this );
    _kcp16V05NotificationProdDat.setCobolName( "KCP16V05-NOTIFICATION-PROD-DAT" );
    _kcp16V05NotificationProdDat.setByteLength( 2 );
    _kcp16V05StmtFirstSheet = BF.createPackedDecimalBinding( "Kcp16V05StmtFirstSheet", "Kcp16V05StmtFirstSheet", Integer.class, this );
    ...
    _kcp16V05StmtLastSheet = BF.createPackedDecimalBinding( "Kcp16V05StmtLastSheet", "Kcp16V05StmtLastSheet", Integer.class, this );
    ...
    _kcp16V05SpecialSheetNumber = BF.createPackedDecimalBinding( "Kcp16V05SpecialSheetNumber", "Kcp16V05SpecialSheetNumber", Integer.class, this );
    ...
    _kcp16V05StmtDest = BF.createStringBinding( "Kcp16V05StmtDest", "Kcp16V05StmtDest", String.class, this );
    _kcp16V05StmtDest.setCobolName( "KCP16V05-STMT-DEST" );
    _kcp16V05StmtDest.setByteLength( 1 );
    _kcp16V05StmtDupDest = BF.createStringBinding( "Kcp16V05StmtDupDest", "Kcp16V05StmtDupDest", String.class, this );
    _kcp16V05StmtDupDest.setCobolName( "KCP16V05-STMT-DUP-DEST" );
    _kcp16V05StmtDupDest.setByteLength( 1 );
    _kcp16V05StmtStdte = BF.createStringBinding( "Kcp16V05StmtStdte", "Kcp16V05StmtStdte", String.class, this );
    _kcp16V05StmtStdte.setCobolName( "KCP16V05-STMT-STDTE" );
    _kcp16V05StmtStdte.setByteLength( 2 );
    _kcp16V05StmtEnddte = BF.createStringBinding( "Kcp16V05StmtEnddte", "Kcp16V05StmtEnddte", String.class, this );
    _kcp16V05StmtEnddte.setCobolName( "KCP16V05-STMT-ENDDTE" );
    _kcp16V05StmtEnddte.setByteLength( 2 );
    _kcp16V05StmtCind = BF.createStringBinding( "Kcp16V05StmtCind", "Kcp16V05StmtCind", String.class, this );
    _kcp16V05StmtCind.setCobolName( "KCP16V05-STMT-CIND" );
    _kcp16V05StmtCind.setByteLength( 1 );
    _kcp16V05Dissenter = BF.createStringBinding( "Kcp16V05Dissenter", "Kcp16V05Dissenter", String.class, this );
    _kcp16V05Dissenter.setCobolName( "KCP16V05-DISSENTER" );
    _kcp16V05Dissenter.setByteLength( 1 );
    _kcp16V05StmtReasno = BF.createPackedDecimalBinding( "Kcp16V05StmtReasno", "Kcp16V05StmtReasno", Short.class, this );
    ...
    _kcp16V05StmtIssreas = BF.createArrayStringBinding( "Kcp16V05StmtIssreas", "Kcp16V05StmtIssreas", String.class, this );
    ...
    _kcp16V05DrSuppListno = BF.createPackedDecimalBinding( "Kcp16V05DrSuppListno", "Kcp16V05DrSuppListno", Short.class, this );
    ...
    _kcp16V05DrSuppListWrapperItem = new Kcp16V05DrSuppListBinding( "Kcp16V05DrSuppListWrapperItem", "Kcp16V05DrSuppList", this, null );
    _kcp16V05DrSuppListWrapper = new Kcp16V05DrSuppListWrapperBinding( "Kcp16V05DrSuppListWrapper", "Kcp16V05DrSuppList", this, _kcp16V05DrSuppListWrapperItem );
    ...
    _kcp16V05CrSuppListno = BF.createPackedDecimalBinding( "Kcp16V05CrSuppListno", "Kcp16V05CrSuppListno", Short.class, this );
    ...
    _kcp16V05CrSuppListWrapperItem = new Kcp16V05CrSuppListBinding( "Kcp16V05CrSuppListWrapperItem", "Kcp16V05CrSuppList", this, null );
    _kcp16V05CrSuppListWrapper = new Kcp16V05CrSuppListWrapperBinding( "Kcp16V05CrSuppListWrapper", "Kcp16V05CrSuppList", this, _kcp16V05CrSuppListWrapperItem );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05NotificatTypeCode" + " value=" + mValueObject.getKcp16V05NotificatTypeCode() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05NotificatSubTypeCd" + " value=" + mValueObject.getKcp16V05NotificatSubTypeCd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05NotificationProdDat" + " value=" + mValueObject.getKcp16V05NotificationProdDat() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtFirstSheet" + " value=" + mValueObject.getKcp16V05StmtFirstSheet() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtLastSheet" + " value=" + mValueObject.getKcp16V05StmtLastSheet() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05SpecialSheetNumber" + " value=" + mValueObject.getKcp16V05SpecialSheetNumber() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtDest" + " value=" + mValueObject.getKcp16V05StmtDest() );
      }
    _kcp16V05StmtDest.setObjectValue( mValueObject.getKcp16V05StmtDest() );
        /* Get Value object property _kcp16V05StmtDupDest */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtDupDest" + " value=" + mValueObject.getKcp16V05StmtDupDest() );
      }
    _kcp16V05StmtDupDest.setObjectValue( mValueObject.getKcp16V05StmtDupDest() );
        /* Get Value object property _kcp16V05StmtStdte */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtStdte" + " value=" + mValueObject.getKcp16V05StmtStdte() );
      }
    _kcp16V05StmtStdte.setObjectValue( mValueObject.getKcp16V05StmtStdte() );
        /* Get Value object property _kcp16V05StmtEnddte */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtEnddte" + " value=" + mValueObject.getKcp16V05StmtEnddte() );
      }
    _kcp16V05StmtEnddte.setObjectValue( mValueObject.getKcp16V05StmtEnddte() );
        /* Get Value object property _kcp16V05StmtCind */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtCind" + " value=" + mValueObject.getKcp16V05StmtCind() );
      }
    _kcp16V05StmtCind.setObjectValue( mValueObject.getKcp16V05StmtCind() );
        /* Get Value object property _kcp16V05Dissenter */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05Dissenter" + " value=" + mValueObject.getKcp16V05Dissenter() );
      }
    _kcp16V05Dissenter.setObjectValue( mValueObject.getKcp16V05Dissenter() );
        /* Get Value object property _kcp16V05StmtReasno */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtReasno" + " value=" + mValueObject.getKcp16V05StmtReasno() );
      }
    _kcp16V05StmtReasno.setObjectValue( mValueObject.getKcp16V05StmtReasno() );
        /* Get Value object property _kcp16V05StmtIssreas */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05StmtIssreas" + " value=" + mValueObject.getKcp16V05StmtIssreas() );
      }
    _kcp16V05StmtIssreas.setObjectValue( mValueObject.getKcp16V05StmtIssreas() );
        /* Get Value object property _kcp16V05DrSuppListno */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05DrSuppListno" + " value=" + mValueObject.getKcp16V05DrSuppListno() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05DrSuppListWrapper" + " value=" + mValueObject.getKcp16V05DrSuppList() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05CrSuppListno" + " value=" + mValueObject.getKcp16V05CrSuppListno() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp16V05CrSuppListWrapper" + " value=" + mValueObject.getKcp16V05CrSuppList() );
      }
