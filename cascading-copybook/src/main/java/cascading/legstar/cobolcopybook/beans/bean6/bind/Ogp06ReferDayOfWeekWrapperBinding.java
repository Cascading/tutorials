...
public class Ogp06ReferDayOfWeekWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Ogp06ReferDayOfWeek> mValueObject;
   ...
   */
  public Ogp06ReferDayOfWeekWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Ogp06ReferDayOfWeek.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 5 );
    setMaxOccurs( 5 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Ogp06ReferDayOfWeek>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Ogp06ReferDayOfWeek >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Ogp06ReferDayOfWeek) getComplexItemBinding().
      getObjectValue( Ogp06ReferDayOfWeek.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Ogp06ReferDayOfWeek>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Ogp06ReferDayOfWeek.class ) )
        {
        mValueObject = (List<Ogp06ReferDayOfWeek>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Ogp06ReferDayOfWeek> getOgp06ReferDayOfWeek() throws HostException
    {
    return (List<Ogp06ReferDayOfWeek>) getObjectValue( Ogp06ReferDayOfWeek.class );
    }
