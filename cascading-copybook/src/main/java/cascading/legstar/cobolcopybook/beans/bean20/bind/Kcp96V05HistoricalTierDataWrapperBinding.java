 ...
 * List < Kcp96V05HistoricalTierData >.
 * <p/>
...
public class Kcp96V05HistoricalTierDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp96V05HistoricalTierData> mValueObject;
   ...
   */
  public Kcp96V05HistoricalTierDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp96V05HistoricalTierData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 4 );
    setMaxOccurs( 4 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp96V05HistoricalTierData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp96V05HistoricalTierData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp96V05HistoricalTierData) getComplexItemBinding().
      getObjectValue( Kcp96V05HistoricalTierData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp96V05HistoricalTierData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp96V05HistoricalTierData.class ) )
        {
        mValueObject = (List<Kcp96V05HistoricalTierData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp96V05HistoricalTierData> getKcp96V05HistoricalTierData() throws HostException
    {
    return (List<Kcp96V05HistoricalTierData>) getObjectValue( Kcp96V05HistoricalTierData.class );
    }
