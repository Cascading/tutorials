 ...
 */
public class Kcp01V05NationalInsuranNo2Binding
   ...
   */
  public Kcp01V05NationalInsuranNo2Binding(
    final Kcp01V05NationalInsuranNo2 valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp01V05NatinsNo2A = BF.createStringBinding( "Kcp01V05NatinsNo2A",
      "Kcp01V05NatinsNo2A", String.class, this );
    _kcp01V05NatinsNo2A.setCobolName( "KCP01V05-NATINS-NO-2A" );
    _kcp01V05NatinsNo2A.setByteLength( 2 );
    _kcp01V05NatinsNo2B = BF.createPackedDecimalBinding( "Kcp01V05NatinsNo2B",
      "Kcp01V05NatinsNo2B", Integer.class, this );
    ...
    _kcp01V05NatinsNo2C = BF.createStringBinding( "Kcp01V05NatinsNo2C",
      "Kcp01V05NatinsNo2C", String.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp01V05NatinsNo2A"
        + " value=" + mValueObject.getKcp01V05NatinsNo2A() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp01V05NatinsNo2B"
        + " value=" + mValueObject.getKcp01V05NatinsNo2B() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp01V05NatinsNo2C"
        + " value=" + mValueObject.getKcp01V05NatinsNo2C() );
      }
