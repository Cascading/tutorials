...
import cascading.legstar.cobolcopybook.beans.abbdfot.ObjectFactory;
 ...
 */
public class BdfoFileTrailerBinding
   ...
   */
  public BdfoFileTrailerBinding(
    final BdfoFileTrailer valueObject )
    {
  ...
  private void initChildren()
    ...
    _bdfoFileTally = BF.createPackedDecimalBinding( "BdfoFileTally",
      "BdfoFileTally", Integer.class, this );
    ...
    _bdfoFileHash = BF.createPackedDecimalBinding( "BdfoFileHash",
      "BdfoFileHash", Integer.class, this );
    ...
    _bdfoNumAccountsSelected = BF.createPackedDecimalBinding( "BdfoNumAccountsSelected",
      "BdfoNumAccountsSelected", Integer.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_bdfoFileTally"
        + " value=" + mValueObject.getBdfoFileTally() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_bdfoFileHash"
        + " value=" + mValueObject.getBdfoFileHash() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_bdfoNumAccountsSelected"
        + " value=" + mValueObject.getBdfoNumAccountsSelected() );
      }
