 ...
 */
public class Kcp97V05HistoricalRateDataBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp97V05HistoricalRateDataBinding( final Kcp97V05HistoricalRateData valueObject )
    {
   ...
   */
  public Kcp97V05HistoricalRateDataBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp97V05HistoricalRateData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp97V05RateEffectiveDate = BF.createStringBinding( "Kcp97V05RateEffectiveDate", "Kcp97V05RateEffectiveDate", String.class, this );
    _kcp97V05RateEffectiveDate.setCobolName( "KCP97V05-RATE-EFFECTIVE-DATE" );
    _kcp97V05RateEffectiveDate.setByteLength( 2 );
    _kcp97V05EffectiveRate = BF.createPackedDecimalBinding( "Kcp97V05EffectiveRate", "Kcp97V05EffectiveRate", BigDecimal.class, this );
    ...
    _kcp97V05RateCode = BF.createStringBinding( "Kcp97V05RateCode", "Kcp97V05RateCode", String.class, this );
    _kcp97V05RateCode.setCobolName( "KCP97V05-RATE-CODE" );
    _kcp97V05RateCode.setByteLength( 1 );
    _kcp97V05DefaultRateCode = BF.createStringBinding( "Kcp97V05DefaultRateCode", "Kcp97V05DefaultRateCode", String.class, this );
    _kcp97V05DefaultRateCode.setCobolName( "KCP97V05-DEFAULT-RATE-CODE" );
    _kcp97V05DefaultRateCode.setByteLength( 1 );
    _kcp97V05MinimumRate = BF.createPackedDecimalBinding( "Kcp97V05MinimumRate", "Kcp97V05MinimumRate", BigDecimal.class, this );
    ...
    _kcp97V05RateLink = BF.createPackedDecimalBinding( "Kcp97V05RateLink", "Kcp97V05RateLink", BigDecimal.class, this );
    ...
    _kcp97V05RateConsistencyInd = BF.createStringBinding( "Kcp97V05RateConsistencyInd", "Kcp97V05RateConsistencyInd", String.class, this );
    _kcp97V05RateConsistencyInd.setCobolName( "KCP97V05-RATE-CONSISTENCY-IND" );
    _kcp97V05RateConsistencyInd.setByteLength( 1 );
    _kcp97V05RateName = BF.createStringBinding( "Kcp97V05RateName", "Kcp97V05RateName", String.class, this );
    _kcp97V05RateName.setCobolName( "KCP97V05-RATE-NAME" );
    _kcp97V05RateName.setByteLength( 15 );
    _kcp97V05ZeroRateCode = BF.createStringBinding( "Kcp97V05ZeroRateCode", "Kcp97V05ZeroRateCode", String.class, this );
    _kcp97V05ZeroRateCode.setCobolName( "KCP97V05-ZERO-RATE-CODE" );
    _kcp97V05ZeroRateCode.setByteLength( 1 );
    _kcp97V05DrintType = BF.createPackedDecimalBinding( "Kcp97V05DrintType", "Kcp97V05DrintType", Short.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05RateEffectiveDate" + " value=" + mValueObject.getKcp97V05RateEffectiveDate() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05EffectiveRate" + " value=" + mValueObject.getKcp97V05EffectiveRate() );
      }
    _kcp97V05EffectiveRate.setObjectValue( mValueObject.getKcp97V05EffectiveRate() );
        /* Get Value object property _kcp97V05RateCode */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05RateCode" + " value=" + mValueObject.getKcp97V05RateCode() );
      }
    _kcp97V05RateCode.setObjectValue( mValueObject.getKcp97V05RateCode() );
        /* Get Value object property _kcp97V05DefaultRateCode */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05DefaultRateCode" + " value=" + mValueObject.getKcp97V05DefaultRateCode() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05MinimumRate" + " value=" + mValueObject.getKcp97V05MinimumRate() );
      }
    _kcp97V05MinimumRate.setObjectValue( mValueObject.getKcp97V05MinimumRate() );
        /* Get Value object property _kcp97V05RateLink */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05RateLink" + " value=" + mValueObject.getKcp97V05RateLink() );
      }
    _kcp97V05RateLink.setObjectValue( mValueObject.getKcp97V05RateLink() );
        /* Get Value object property _kcp97V05RateConsistencyInd */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05RateConsistencyInd" + " value=" + mValueObject.getKcp97V05RateConsistencyInd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05RateName" + " value=" + mValueObject.getKcp97V05RateName() );
      }
    _kcp97V05RateName.setObjectValue( mValueObject.getKcp97V05RateName() );
        /* Get Value object property _kcp97V05ZeroRateCode */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05ZeroRateCode" + " value=" + mValueObject.getKcp97V05ZeroRateCode() );
      }
    _kcp97V05ZeroRateCode.setObjectValue( mValueObject.getKcp97V05ZeroRateCode() );
        /* Get Value object property _kcp97V05DrintType */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp97V05DrintType" + " value=" + mValueObject.getKcp97V05DrintType() );
      }
