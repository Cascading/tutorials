...
public class Kcp18V05LnameDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp18V05LnameData> mValueObject;
   ...
   */
  public Kcp18V05LnameDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp18V05LnameData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( -1 );
    setMaxOccurs( 10 );
    setDependingOn( "KCP18V05-NO-OF-LONG-NAMES" );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp18V05LnameData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp18V05LnameData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp18V05LnameData) getComplexItemBinding().
      getObjectValue( Kcp18V05LnameData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp18V05LnameData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp18V05LnameData.class ) )
        {
        mValueObject = (List<Kcp18V05LnameData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp18V05LnameData> getKcp18V05LnameData() throws HostException
    {
    return (List<Kcp18V05LnameData>) getObjectValue( Kcp18V05LnameData.class );
    }
