...
/**
 * Transforms a BdfoCommonData data object to mainframe data.
 * <p/>
 * This is a typical use of this class:
 * <pre>
 *  BdfoCommonDataJavaToHostTransformer transformer = new BdfoCommonDataJavaToHostTransformer();
 *  byte[] hostByteArray = transformer.transform(javaValue);
 * </pre>
 */
public class BdfoCommonDataJavaToHostTransformer extends AbstractJavaToHostTransformer
  {
   ...
   */
  public BdfoCommonDataJavaToHostTransformer()
    {
    super();
    }
   ...
   */
  public BdfoCommonDataJavaToHostTransformer( final CobolContext cobolContext )
    {
    super( cobolContext );
    }
   ...
   */
  public BdfoCommonDataJavaToHostTransformer( final String hostCharset )
    {
    super( hostCharset );
    }
