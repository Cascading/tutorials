...
public class Kcp97V05DrintRatesTransformers extends AbstractTransformers
  ...
  public Kcp97V05DrintRatesTransformers()
    {
    super( new Kcp97V05DrintRatesJavaToHostTransformer(),
      new Kcp97V05DrintRatesHostToJavaTransformer() );
    }
   ...
   */
  public Kcp97V05DrintRates toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp97V05DrintRates toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp97V05DrintRates toJava( final byte[] hostData, final int offset,
