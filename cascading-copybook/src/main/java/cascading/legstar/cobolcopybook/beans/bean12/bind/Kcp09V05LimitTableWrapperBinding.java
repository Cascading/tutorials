...
public class Kcp09V05LimitTableWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  public Kcp09V05LimitTableWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp09V05LimitTable >" + " value=" + mValueObject.get( index ) );
        }
