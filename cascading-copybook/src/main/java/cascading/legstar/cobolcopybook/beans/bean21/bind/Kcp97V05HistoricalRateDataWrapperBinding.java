 ...
 * List < Kcp97V05HistoricalRateData >.
 * <p/>
...
public class Kcp97V05HistoricalRateDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp97V05HistoricalRateData> mValueObject;
   ...
   */
  public Kcp97V05HistoricalRateDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp97V05HistoricalRateData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 4 );
    setMaxOccurs( 4 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp97V05HistoricalRateData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp97V05HistoricalRateData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp97V05HistoricalRateData) getComplexItemBinding().
      getObjectValue( Kcp97V05HistoricalRateData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp97V05HistoricalRateData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp97V05HistoricalRateData.class ) )
        {
        mValueObject = (List<Kcp97V05HistoricalRateData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp97V05HistoricalRateData> getKcp97V05HistoricalRateData() throws HostException
    {
    return (List<Kcp97V05HistoricalRateData>) getObjectValue( Kcp97V05HistoricalRateData.class );
    }
