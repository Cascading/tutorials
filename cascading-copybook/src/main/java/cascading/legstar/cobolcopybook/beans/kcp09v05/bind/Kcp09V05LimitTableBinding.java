 ...
 */
public class Kcp09V05LimitTableBinding
   ...
   */
  public Kcp09V05LimitTableBinding(
    final Kcp09V05LimitTable valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp09V05LimitIdent = BF.createPackedDecimalBinding( "Kcp09V05LimitIdent",
      "Kcp09V05LimitIdent", Short.class, this );
    ...
    _kcp09V05Limit = BF.createPackedDecimalBinding( "Kcp09V05Limit",
      "Kcp09V05Limit", BigDecimal.class, this );
    ...
    _kcp09V05LimitSubCode = BF.createStringBinding( "Kcp09V05LimitSubCode",
      "Kcp09V05LimitSubCode", String.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp09V05LimitIdent"
        + " value=" + mValueObject.getKcp09V05LimitIdent() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp09V05Limit"
        + " value=" + mValueObject.getKcp09V05Limit() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp09V05LimitSubCode"
        + " value=" + mValueObject.getKcp09V05LimitSubCode() );
      }
