...
import cascading.legstar.cobolcopybook.beans.kcp13v05.Kcp13V05NotificatFreqDetail;
import cascading.legstar.cobolcopybook.beans.kcp13v05.Kcp13V05PrenotPrintDates;
 ...
 */
public class Kcp13V05NotificatDiaryDataBinding
   ...
   */
  public Kcp13V05NotificatDiaryDataBinding(
    final Kcp13V05NotificatDiaryData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp13V05NotificatTypeCode = BF.createStringBinding( "Kcp13V05NotificatTypeCode",
      "Kcp13V05NotificatTypeCode", String.class, this );
    _kcp13V05NotificatTypeCode.setCobolName( "KCP13V05-NOTIFICAT-TYPE-CODE" );
    _kcp13V05NotificatTypeCode.setByteLength( 1 );
    _kcp13V05NotificatSubTypeCd = BF.createStringBinding( "Kcp13V05NotificatSubTypeCd",
      "Kcp13V05NotificatSubTypeCd", String.class, this );
    _kcp13V05NotificatSubTypeCd.setCobolName( "KCP13V05-NOTIFICAT-SUB-TYPE-CD" );
    _kcp13V05NotificatSubTypeCd.setByteLength( 1 );
    _kcp13V05NotificatSuppressCd = BF.createStringBinding( "Kcp13V05NotificatSuppressCd",
      "Kcp13V05NotificatSuppressCd", String.class, this );
    _kcp13V05NotificatSuppressCd.setCobolName( "KCP13V05-NOTIFICAT-SUPPRESS-CD" );
    _kcp13V05NotificatSuppressCd.setByteLength( 1 );
    _kcp13V05NotificatMmsgSupCd = BF.createStringBinding( "Kcp13V05NotificatMmsgSupCd",
      "Kcp13V05NotificatMmsgSupCd", String.class, this );
    _kcp13V05NotificatMmsgSupCd.setCobolName( "KCP13V05-NOTIFICAT-MMSG-SUP-CD" );
    _kcp13V05NotificatMmsgSupCd.setByteLength( 1 );
    _kcp13V05NotificatPmsgSupCd = BF.createStringBinding( "Kcp13V05NotificatPmsgSupCd",
      "Kcp13V05NotificatPmsgSupCd", String.class, this );
    _kcp13V05NotificatPmsgSupCd.setCobolName( "KCP13V05-NOTIFICAT-PMSG-SUP-CD" );
    _kcp13V05NotificatPmsgSupCd.setByteLength( 1 );
    _kcp13V05StmtDest = BF.createStringBinding( "Kcp13V05StmtDest",
      "Kcp13V05StmtDest", String.class, this );
    _kcp13V05StmtDest.setCobolName( "KCP13V05-STMT-DEST" );
    _kcp13V05StmtDest.setByteLength( 1 );
    _kcp13V05StmtDupDest = BF.createStringBinding( "Kcp13V05StmtDupDest",
      "Kcp13V05StmtDupDest", String.class, this );
    _kcp13V05StmtDupDest.setCobolName( "KCP13V05-STMT-DUP-DEST" );
    _kcp13V05StmtDupDest.setByteLength( 1 );
    _kcp13V05StmtCind = BF.createStringBinding( "Kcp13V05StmtCind",
      "Kcp13V05StmtCind", String.class, this );
    _kcp13V05StmtCind.setCobolName( "KCP13V05-STMT-CIND" );
    _kcp13V05StmtCind.setByteLength( 1 );
    _kcp13V05Dissenter = BF.createStringBinding( "Kcp13V05Dissenter",
      "Kcp13V05Dissenter", String.class, this );
    _kcp13V05Dissenter.setCobolName( "KCP13V05-DISSENTER" );
    _kcp13V05Dissenter.setByteLength( 1 );
    _kcp13V05StmtDup = BF.createStringBinding( "Kcp13V05StmtDup",
      "Kcp13V05StmtDup", String.class, this );
    _kcp13V05StmtDup.setCobolName( "KCP13V05-STMT-DUP" );
    _kcp13V05StmtDup.setByteLength( 1 );
    _kcp13V05StmtDestClass = BF.createZonedDecimalBinding( "Kcp13V05StmtDestClass",
      "Kcp13V05StmtDestClass", Integer.class, this );
    ...
    _kcp13V05StmtLayout = BF.createPackedDecimalBinding( "Kcp13V05StmtLayout",
      "Kcp13V05StmtLayout", Short.class, this );
    ...
    _kcp13V05NoOfPrenotDates = BF.createZonedDecimalBinding( "Kcp13V05NoOfPrenotDates",
      "Kcp13V05NoOfPrenotDates", Integer.class, this );
    ...
    _kcp13V05PrenotPrintDatesWrapperItem = new Kcp13V05PrenotPrintDatesBinding( "Kcp13V05PrenotPrintDatesWrapperItem",
      "Kcp13V05PrenotPrintDates", this, null );
    _kcp13V05PrenotPrintDatesWrapper = new Kcp13V05PrenotPrintDatesWrapperBinding( "Kcp13V05PrenotPrintDatesWrapper",
      "Kcp13V05PrenotPrintDates", this, _kcp13V05PrenotPrintDatesWrapperItem );
    ...
    _kcp13V05NoOfFrequencies = BF.createZonedDecimalBinding( "Kcp13V05NoOfFrequencies",
      "Kcp13V05NoOfFrequencies", Integer.class, this );
    ...
    _kcp13V05NotificatFreqDetailWrapperItem = new Kcp13V05NotificatFreqDetailBinding( "Kcp13V05NotificatFreqDetailWrapperItem",
      "Kcp13V05NotificatFreqDetail", this, null );
    _kcp13V05NotificatFreqDetailWrapper = new Kcp13V05NotificatFreqDetailWrapperBinding( "Kcp13V05NotificatFreqDetailWrapper",
      "Kcp13V05NotificatFreqDetail", this, _kcp13V05NotificatFreqDetailWrapperItem );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatTypeCode"
        + " value=" + mValueObject.getKcp13V05NotificatTypeCode() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatSubTypeCd"
        + " value=" + mValueObject.getKcp13V05NotificatSubTypeCd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatSuppressCd"
        + " value=" + mValueObject.getKcp13V05NotificatSuppressCd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatMmsgSupCd"
        + " value=" + mValueObject.getKcp13V05NotificatMmsgSupCd() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatPmsgSupCd"
        + " value=" + mValueObject.getKcp13V05NotificatPmsgSupCd() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtDest"
        + " value=" + mValueObject.getKcp13V05StmtDest() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtDupDest"
        + " value=" + mValueObject.getKcp13V05StmtDupDest() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtCind"
        + " value=" + mValueObject.getKcp13V05StmtCind() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05Dissenter"
        + " value=" + mValueObject.getKcp13V05Dissenter() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtDup"
        + " value=" + mValueObject.getKcp13V05StmtDup() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtDestClass"
        + " value=" + mValueObject.getKcp13V05StmtDestClass() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05StmtLayout"
        + " value=" + mValueObject.getKcp13V05StmtLayout() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NoOfPrenotDates"
        + " value=" + mValueObject.getKcp13V05NoOfPrenotDates() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05PrenotPrintDatesWrapper"
        + " value=" + mValueObject.getKcp13V05PrenotPrintDates() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NoOfFrequencies"
        + " value=" + mValueObject.getKcp13V05NoOfFrequencies() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp13V05NotificatFreqDetailWrapper"
        + " value=" + mValueObject.getKcp13V05NotificatFreqDetail() );
      }
