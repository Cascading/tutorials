 ...
 */
public class BdfoCommonDataBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public BdfoCommonDataBinding( final BdfoCommonData valueObject )
    {
   ...
   */
  public BdfoCommonDataBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final BdfoCommonData valueObject )
    {
  ...
  private void initChildren()
    ...
    _bdfoLen = BF.createBinaryBinding( "BdfoLen", "BdfoLen", Short.class, this );
    _bdfoLen.setCobolName( "BDFO-LEN" );
    _bdfoLen.setByteLength( 2 );
    _bdfoLen.setTotalDigits( 4 );
    _bdfoLen.setIsSigned( true );
    _bdfoKey = BF.createPackedDecimalBinding( "BdfoKey", "BdfoKey", Long.class, this );
    _bdfoKey.setCobolName( "BDFO-KEY" );
    _bdfoKey.setByteLength( 7 );
    _bdfoKey.setTotalDigits( 13 );
    _bdfoKey.setIsSigned( true );
    _bdfoParmNo = BF.createZonedDecimalBinding( "BdfoParmNo", "BdfoParmNo", Integer.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_bdfoLen" + " value=" + mValueObject.getBdfoLen() );
      }
    _bdfoLen.setObjectValue( mValueObject.getBdfoLen() );
        /* Get Value object property _bdfoKey */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_bdfoKey" + " value=" + mValueObject.getBdfoKey() );
      }
    _bdfoKey.setObjectValue( mValueObject.getBdfoKey() );
        /* Get Value object property _bdfoParmNo */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_bdfoParmNo" + " value=" + mValueObject.getBdfoParmNo() );
      }
