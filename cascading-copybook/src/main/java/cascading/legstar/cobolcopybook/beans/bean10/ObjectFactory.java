 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean10 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp07V05BalDetails_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean10", "kcp07V05BalDetails" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean10
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean10", name = "kcp07V05BalDetails")
