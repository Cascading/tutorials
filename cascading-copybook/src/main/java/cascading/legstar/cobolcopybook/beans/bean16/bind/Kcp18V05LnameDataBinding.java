 ...
 */
public class Kcp18V05LnameDataBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp18V05LnameDataBinding( final Kcp18V05LnameData valueObject )
    {
   ...
   */
  public Kcp18V05LnameDataBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp18V05LnameData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp18V05LnameStartDate = BF.createStringBinding( "Kcp18V05LnameStartDate", "Kcp18V05LnameStartDate", String.class, this );
    _kcp18V05LnameStartDate.setCobolName( "KCP18V05-LNAME-START-DATE" );
    _kcp18V05LnameStartDate.setByteLength( 2 );
    _kcp18V05LnameEndDate = BF.createStringBinding( "Kcp18V05LnameEndDate", "Kcp18V05LnameEndDate", String.class, this );
    _kcp18V05LnameEndDate.setCobolName( "KCP18V05-LNAME-END-DATE" );
    _kcp18V05LnameEndDate.setByteLength( 2 );
    _kcp18V05LnameL1 = BF.createStringBinding( "Kcp18V05LnameL1", "Kcp18V05LnameL1", String.class, this );
    _kcp18V05LnameL1.setCobolName( "KCP18V05-LNAME-L1" );
    _kcp18V05LnameL1.setByteLength( 58 );
    _kcp18V05LnameL2 = BF.createStringBinding( "Kcp18V05LnameL2", "Kcp18V05LnameL2", String.class, this );
    _kcp18V05LnameL2.setCobolName( "KCP18V05-LNAME-L2" );
    _kcp18V05LnameL2.setByteLength( 58 );
    _kcp18V05LnameL3 = BF.createStringBinding( "Kcp18V05LnameL3", "Kcp18V05LnameL3", String.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LnameStartDate" + " value=" + mValueObject.getKcp18V05LnameStartDate() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LnameEndDate" + " value=" + mValueObject.getKcp18V05LnameEndDate() );
      }
    _kcp18V05LnameEndDate.setObjectValue( mValueObject.getKcp18V05LnameEndDate() );
        /* Get Value object property _kcp18V05LnameL1 */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LnameL1" + " value=" + mValueObject.getKcp18V05LnameL1() );
      }
    _kcp18V05LnameL1.setObjectValue( mValueObject.getKcp18V05LnameL1() );
        /* Get Value object property _kcp18V05LnameL2 */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LnameL2" + " value=" + mValueObject.getKcp18V05LnameL2() );
      }
    _kcp18V05LnameL2.setObjectValue( mValueObject.getKcp18V05LnameL2() );
        /* Get Value object property _kcp18V05LnameL3 */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp18V05LnameL3" + " value=" + mValueObject.getKcp18V05LnameL3() );
      }
