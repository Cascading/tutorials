...
import cascading.legstar.cobolcopybook.beans.kc3ogp04.ObjectFactory;
 ...
 */
public class Ogp04RepaymentDataBinding
   ...
   */
  public Ogp04RepaymentDataBinding(
    final Ogp04RepaymentData valueObject )
    {
  ...
  private void initChildren()
    ...
    _ogp04LbloanMat = BF.createStringBinding( "Ogp04LbloanMat",
      "Ogp04LbloanMat", String.class, this );
    _ogp04LbloanMat.setCobolName( "OGP04-LBLOAN-MAT" );
    _ogp04LbloanMat.setByteLength( 2 );
    _ogp04Repamt = BF.createPackedDecimalBinding( "Ogp04Repamt",
      "Ogp04Repamt", BigDecimal.class, this );
    ...
    _ogp04Repfreq = BF.createPackedDecimalBinding( "Ogp04Repfreq",
      "Ogp04Repfreq", Short.class, this );
    ...
    _ogp04Repdte = BF.createStringBinding( "Ogp04Repdte",
      "Ogp04Repdte", String.class, this );
    _ogp04Repdte.setCobolName( "OGP04-REPDTE" );
    _ogp04Repdte.setByteLength( 2 );
    _ogp04Reptyp = BF.createPackedDecimalBinding( "Ogp04Reptyp",
      "Ogp04Reptyp", Short.class, this );
    ...
    _ogp04Borrow = BF.createPackedDecimalBinding( "Ogp04Borrow",
      "Ogp04Borrow", Short.class, this );
    ...
    _ogp04Amtsanc = BF.createPackedDecimalBinding( "Ogp04Amtsanc",
      "Ogp04Amtsanc", BigDecimal.class, this );
    ...
    _ogp04MirasDate = BF.createStringBinding( "Ogp04MirasDate",
      "Ogp04MirasDate", String.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04LbloanMat"
        + " value=" + mValueObject.getOgp04LbloanMat() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Repamt"
        + " value=" + mValueObject.getOgp04Repamt() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Repfreq"
        + " value=" + mValueObject.getOgp04Repfreq() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Repdte"
        + " value=" + mValueObject.getOgp04Repdte() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Reptyp"
        + " value=" + mValueObject.getOgp04Reptyp() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Borrow"
        + " value=" + mValueObject.getOgp04Borrow() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04Amtsanc"
        + " value=" + mValueObject.getOgp04Amtsanc() );
      }
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_ogp04MirasDate"
        + " value=" + mValueObject.getOgp04MirasDate() );
      }
