package cascading.legstar.cobolcopybook.beans.kcp08v05;
 ...
 * generated in the cascading.legstar.cobolcopybook.beans.kcp08v05 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp08V05AuthLimits_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/kcp08v05", "kcp08V05AuthLimits" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.kcp08v05
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/kcp08v05", name = "kcp08V05AuthLimits")
