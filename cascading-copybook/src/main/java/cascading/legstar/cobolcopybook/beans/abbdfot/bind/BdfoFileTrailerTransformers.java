...
import cascading.legstar.cobolcopybook.beans.abbdfot.BdfoFileTrailer;
...
public class BdfoFileTrailerTransformers extends AbstractTransformers
  ...
  public BdfoFileTrailerTransformers()
    {
    super( new BdfoFileTrailerJavaToHostTransformer(),
      new BdfoFileTrailerHostToJavaTransformer() );
    }
   ...
   */
  public BdfoFileTrailer toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoFileTrailer toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoFileTrailer toJava( final byte[] hostData, final int offset,
