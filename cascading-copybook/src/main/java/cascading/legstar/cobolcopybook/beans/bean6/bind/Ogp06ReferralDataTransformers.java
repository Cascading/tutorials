...
public class Ogp06ReferralDataTransformers extends AbstractTransformers
  ...
  public Ogp06ReferralDataTransformers()
    {
    super( new Ogp06ReferralDataJavaToHostTransformer(),
      new Ogp06ReferralDataHostToJavaTransformer() );
    }
   ...
   */
  public Ogp06ReferralData toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Ogp06ReferralData toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Ogp06ReferralData toJava( final byte[] hostData, final int offset,
