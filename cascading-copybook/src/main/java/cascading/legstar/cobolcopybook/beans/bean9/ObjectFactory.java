 ...
 * generated in the cascading.legstar.cobolcopybook.beans.bean9 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp05V10ProfileMarkers_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/bean9", "kcp05V10ProfileMarkers" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.bean9
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/bean9", name = "kcp05V10ProfileMarkers")
