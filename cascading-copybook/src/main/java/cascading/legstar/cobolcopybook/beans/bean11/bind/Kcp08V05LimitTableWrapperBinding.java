...
public class Kcp08V05LimitTableWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp08V05LimitTable> mValueObject;
   ...
   */
  public Kcp08V05LimitTableWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp08V05LimitTable.class, null, parentBinding, complexItemBinding );
    setMinOccurs( -1 );
    setMaxOccurs( 10 );
    setDependingOn( "KCP08V05-NO-OF-LIMS" );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp08V05LimitTable>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp08V05LimitTable >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp08V05LimitTable) getComplexItemBinding().
      getObjectValue( Kcp08V05LimitTable.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp08V05LimitTable>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp08V05LimitTable.class ) )
        {
        mValueObject = (List<Kcp08V05LimitTable>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp08V05LimitTable> getKcp08V05LimitTable() throws HostException
    {
    return (List<Kcp08V05LimitTable>) getObjectValue( Kcp08V05LimitTable.class );
    }
