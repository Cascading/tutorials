...
public class Kcp17V05AddressDtlsWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  public Kcp17V05AddressDtlsWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp17V05AddressDtls >" + " value=" + mValueObject.get( index ) );
        }
