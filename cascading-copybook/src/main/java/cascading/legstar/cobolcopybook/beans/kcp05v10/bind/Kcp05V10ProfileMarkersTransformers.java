...
public class Kcp05V10ProfileMarkersTransformers extends AbstractTransformers
  ...
  public Kcp05V10ProfileMarkersTransformers()
    {
    super( new Kcp05V10ProfileMarkersJavaToHostTransformer(),
      new Kcp05V10ProfileMarkersHostToJavaTransformer() );
    }
   ...
   */
  public Kcp05V10ProfileMarkers toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp05V10ProfileMarkers toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp05V10ProfileMarkers toJava( final byte[] hostData, final int offset,
