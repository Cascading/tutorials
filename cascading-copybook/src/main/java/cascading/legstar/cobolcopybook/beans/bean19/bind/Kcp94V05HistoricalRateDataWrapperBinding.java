 ...
 * List < Kcp94V05HistoricalRateData >.
 * <p/>
...
public class Kcp94V05HistoricalRateDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp94V05HistoricalRateData> mValueObject;
   ...
   */
  public Kcp94V05HistoricalRateDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp94V05HistoricalRateData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 4 );
    setMaxOccurs( 4 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp94V05HistoricalRateData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp94V05HistoricalRateData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp94V05HistoricalRateData) getComplexItemBinding().
      getObjectValue( Kcp94V05HistoricalRateData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp94V05HistoricalRateData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp94V05HistoricalRateData.class ) )
        {
        mValueObject = (List<Kcp94V05HistoricalRateData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp94V05HistoricalRateData> getKcp94V05HistoricalRateData() throws HostException
    {
    return (List<Kcp94V05HistoricalRateData>) getObjectValue( Kcp94V05HistoricalRateData.class );
    }
