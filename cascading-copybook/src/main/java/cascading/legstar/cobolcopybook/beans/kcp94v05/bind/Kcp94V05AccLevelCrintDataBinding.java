 ...
 */
public class Kcp94V05AccLevelCrintDataBinding
   ...
   */
  public Kcp94V05AccLevelCrintDataBinding(
    final Kcp94V05AccLevelCrintData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp94V05NoOfTiers1 = BF.createPackedDecimalBinding( "Kcp94V05NoOfTiers1",
      "Kcp94V05NoOfTiers1", Short.class, this );
    ...
    _kcp94V05InterestRateData = new Kcp94V05InterestRateDataBinding( "Kcp94V05InterestRateData",
      "Kcp94V05InterestRateData", this, null );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp94V05NoOfTiers1"
        + " value=" + mValueObject.getKcp94V05NoOfTiers1() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property "
        + "_kcp94V05InterestRateData"
        + " value=" + mValueObject.getKcp94V05InterestRateData() );
      }
