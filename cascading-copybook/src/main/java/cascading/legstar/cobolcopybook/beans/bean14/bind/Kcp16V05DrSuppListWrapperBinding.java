...
public class Kcp16V05DrSuppListWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  public Kcp16V05DrSuppListWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp16V05DrSuppList >" + " value=" + mValueObject.get( index ) );
        }
