...
import cascading.legstar.cobolcopybook.beans.bean6.ObjectFactory;
import cascading.legstar.cobolcopybook.beans.bean6.Ogp06ReferDayOfWeek;
 ...
 */
public class Ogp06ReferralDataBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Ogp06ReferralDataBinding( final Ogp06ReferralData valueObject )
    {
   ...
   */
  public Ogp06ReferralDataBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Ogp06ReferralData valueObject )
    {
  ...
  private void initChildren()
    ...
    _ogp06FhReferStreamNo = BF.createPackedDecimalBinding( "Ogp06FhReferStreamNo", "Ogp06FhReferStreamNo", Short.class, this );
    ...
    _ogp06ReferDueDate = BF.createStringBinding( "Ogp06ReferDueDate", "Ogp06ReferDueDate", String.class, this );
    _ogp06ReferDueDate.setCobolName( "OGP06-REFER-DUE-DATE" );
    _ogp06ReferDueDate.setByteLength( 2 );
    _ogp06Refind = BF.createPackedDecimalBinding( "Ogp06Refind", "Ogp06Refind", Short.class, this );
    ...
    _ogp06ReferReason = BF.createPackedDecimalBinding( "Ogp06ReferReason", "Ogp06ReferReason", Short.class, this );
    ...
    _ogp06ReferReasonDesc = BF.createStringBinding( "Ogp06ReferReasonDesc", "Ogp06ReferReasonDesc", String.class, this );
    _ogp06ReferReasonDesc.setCobolName( "OGP06-REFER-REASON-DESC" );
    _ogp06ReferReasonDesc.setByteLength( 30 );
    _ogp06ReferMonthDay = BF.createPackedDecimalBinding( "Ogp06ReferMonthDay", "Ogp06ReferMonthDay", Short.class, this );
    ...
    _ogp06ReferFreq = BF.createStringBinding( "Ogp06ReferFreq", "Ogp06ReferFreq", String.class, this );
    _ogp06ReferFreq.setCobolName( "OGP06-REFER-FREQ" );
    _ogp06ReferFreq.setByteLength( 1 );
    _ogp06ReferDayOfWeekWrapperItem = new Ogp06ReferDayOfWeekBinding( "Ogp06ReferDayOfWeekWrapperItem", "Ogp06ReferDayOfWeek", this, null );
    _ogp06ReferDayOfWeekWrapper = new Ogp06ReferDayOfWeekWrapperBinding( "Ogp06ReferDayOfWeekWrapper", "Ogp06ReferDayOfWeek", this, _ogp06ReferDayOfWeekWrapperItem );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06FhReferStreamNo" + " value=" + mValueObject.getOgp06FhReferStreamNo() );
      }
    _ogp06FhReferStreamNo.setObjectValue( mValueObject.getOgp06FhReferStreamNo() );
        /* Get Value object property _ogp06ReferDueDate */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferDueDate" + " value=" + mValueObject.getOgp06ReferDueDate() );
      }
    _ogp06ReferDueDate.setObjectValue( mValueObject.getOgp06ReferDueDate() );
        /* Get Value object property _ogp06Refind */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06Refind" + " value=" + mValueObject.getOgp06Refind() );
      }
    _ogp06Refind.setObjectValue( mValueObject.getOgp06Refind() );
        /* Get Value object property _ogp06ReferReason */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferReason" + " value=" + mValueObject.getOgp06ReferReason() );
      }
    _ogp06ReferReason.setObjectValue( mValueObject.getOgp06ReferReason() );
        /* Get Value object property _ogp06ReferReasonDesc */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferReasonDesc" + " value=" + mValueObject.getOgp06ReferReasonDesc() );
      }
    _ogp06ReferReasonDesc.setObjectValue( mValueObject.getOgp06ReferReasonDesc() );
        /* Get Value object property _ogp06ReferMonthDay */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferMonthDay" + " value=" + mValueObject.getOgp06ReferMonthDay() );
      }
    _ogp06ReferMonthDay.setObjectValue( mValueObject.getOgp06ReferMonthDay() );
        /* Get Value object property _ogp06ReferFreq */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferFreq" + " value=" + mValueObject.getOgp06ReferFreq() );
      }
    _ogp06ReferFreq.setObjectValue( mValueObject.getOgp06ReferFreq() );
        /* Get Value object property _ogp06ReferDayOfWeekWrapper */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_ogp06ReferDayOfWeekWrapper" + " value=" + mValueObject.getOgp06ReferDayOfWeek() );
      }
