...
public class Kcp16V05CrSuppListWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  public Kcp16V05CrSuppListWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp16V05CrSuppList >" + " value=" + mValueObject.get( index ) );
        }
