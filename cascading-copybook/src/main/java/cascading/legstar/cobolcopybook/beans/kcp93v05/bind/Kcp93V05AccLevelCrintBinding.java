 ...
 */
public class Kcp93V05AccLevelCrintBinding
   ...
   */
  public Kcp93V05AccLevelCrintBinding(
    final Kcp93V05AccLevelCrint valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp93V05AccLevelCrintTiers = new Kcp93V05AccLevelCrintTiersBinding( "Kcp93V05AccLevelCrintTiers",
      "Kcp93V05AccLevelCrintTiers", this, null );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      ...
      _log.debug( "Getting value from Value object property "
        + "_kcp93V05AccLevelCrintTiers"
        + " value=" + mValueObject.getKcp93V05AccLevelCrintTiers() );
      }
