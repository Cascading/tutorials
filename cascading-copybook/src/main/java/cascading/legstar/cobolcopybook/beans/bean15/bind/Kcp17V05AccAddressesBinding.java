 ...
 */
public class Kcp17V05AccAddressesBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp17V05AccAddressesBinding( final Kcp17V05AccAddresses valueObject )
    {
   ...
   */
  public Kcp17V05AccAddressesBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp17V05AccAddresses valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp17V05AddressData = new Kcp17V05AddressDataBinding( "Kcp17V05AddressData", "Kcp17V05AddressData", this, null );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp17V05AddressData" + " value=" + mValueObject.getKcp17V05AddressData() );
      }
