...
public class Kcp96V05TierLimitDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp96V05TierLimitData> mValueObject;
   ...
   */
  public Kcp96V05TierLimitDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp96V05TierLimitData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 3 );
    setMaxOccurs( 3 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp96V05TierLimitData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp96V05TierLimitData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp96V05TierLimitData) getComplexItemBinding().
      getObjectValue( Kcp96V05TierLimitData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp96V05TierLimitData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp96V05TierLimitData.class ) )
        {
        mValueObject = (List<Kcp96V05TierLimitData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp96V05TierLimitData> getKcp96V05TierLimitData() throws HostException
    {
    return (List<Kcp96V05TierLimitData>) getObjectValue( Kcp96V05TierLimitData.class );
    }
