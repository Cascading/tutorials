...
public class BdfoFileHeaderTransformers extends AbstractTransformers
  ...
  public BdfoFileHeaderTransformers()
    {
    super( new BdfoFileHeaderJavaToHostTransformer(),
      new BdfoFileHeaderHostToJavaTransformer() );
    }
   ...
   */
  public BdfoFileHeader toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoFileHeader toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoFileHeader toJava( final byte[] hostData, final int offset,
