...
public class Kcp13V05PrenotPrintDatesWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp13V05PrenotPrintDates> mValueObject;
   ...
   */
  public Kcp13V05PrenotPrintDatesWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp13V05PrenotPrintDates.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 3 );
    setMaxOccurs( 3 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp13V05PrenotPrintDates>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp13V05PrenotPrintDates >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp13V05PrenotPrintDates) getComplexItemBinding().
      getObjectValue( Kcp13V05PrenotPrintDates.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp13V05PrenotPrintDates>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp13V05PrenotPrintDates.class ) )
        {
        mValueObject = (List<Kcp13V05PrenotPrintDates>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp13V05PrenotPrintDates> getKcp13V05PrenotPrintDates() throws HostException
    {
    return (List<Kcp13V05PrenotPrintDates>) getObjectValue( Kcp13V05PrenotPrintDates.class );
    }
