 ...
 */
public class Kcp13V05NotificationDataBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp13V05NotificationDataBinding( final Kcp13V05NotificationData valueObject )
    {
   ...
   */
  public Kcp13V05NotificationDataBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp13V05NotificationData valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp13V05NoOfDiaries = BF.createZonedDecimalBinding( "Kcp13V05NoOfDiaries", "Kcp13V05NoOfDiaries", Integer.class, this );
    ...
    _kcp13V05NotificatDiaryDataWrapperItem = new Kcp13V05NotificatDiaryDataBinding( "Kcp13V05NotificatDiaryDataWrapperItem", "Kcp13V05NotificatDiaryData", this, null );
    _kcp13V05NotificatDiaryDataWrapper = new Kcp13V05NotificatDiaryDataWrapperBinding( "Kcp13V05NotificatDiaryDataWrapper", "Kcp13V05NotificatDiaryData", this, _kcp13V05NotificatDiaryDataWrapperItem );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp13V05NoOfDiaries" + " value=" + mValueObject.getKcp13V05NoOfDiaries() );
      }
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp13V05NotificatDiaryDataWrapper" + " value=" + mValueObject.getKcp13V05NotificatDiaryData() );
      }
    ...
    setCounterValue( _kcp13V05NotificatDiaryDataWrapper.getDependingOn(), ( (List<?>) mValueObject.getKcp13V05NotificatDiaryData() ).size() );
    }
