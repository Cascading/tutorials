 ...
 * generated in the cascading.legstar.cobolcopybook.beans.kcp83v05 package.
...
public class ObjectFactory
  ...
  private final static QName _Kcp83V05InterestRewardData_QNAME = new QName( "http://beans.cobolcopybook.legstar.cascading/kcp83v05", "kcp83V05InterestRewardData" );

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cascading.legstar.cobolcopybook.beans.kcp83v05
   */
   ...
   */
  @XmlElementDecl(namespace = "http://beans.cobolcopybook.legstar.cascading/kcp83v05", name = "kcp83V05InterestRewardData")
