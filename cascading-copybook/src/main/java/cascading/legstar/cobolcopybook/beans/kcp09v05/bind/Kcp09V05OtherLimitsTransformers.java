...
public class Kcp09V05OtherLimitsTransformers extends AbstractTransformers
  ...
  public Kcp09V05OtherLimitsTransformers()
    {
    super( new Kcp09V05OtherLimitsJavaToHostTransformer(),
      new Kcp09V05OtherLimitsHostToJavaTransformer() );
    }
   ...
   */
  public Kcp09V05OtherLimits toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp09V05OtherLimits toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp09V05OtherLimits toJava( final byte[] hostData, final int offset,
