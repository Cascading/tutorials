package cascading.legstar.cobolcopybook.beans.kc3ogp03.bind;
...
public class Ogp03AccountTaxDataTransformers extends AbstractTransformers
  ...
  public Ogp03AccountTaxDataTransformers()
    {
    super( new Ogp03AccountTaxDataJavaToHostTransformer(),
      new Ogp03AccountTaxDataHostToJavaTransformer() );
    }
   ...
   */
  public Ogp03AccountTaxData toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Ogp03AccountTaxData toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Ogp03AccountTaxData toJava( final byte[] hostData, final int offset,
