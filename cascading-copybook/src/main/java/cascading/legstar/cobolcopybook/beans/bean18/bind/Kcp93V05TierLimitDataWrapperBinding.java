...
public class Kcp93V05TierLimitDataWrapperBinding extends CArrayComplexBinding
  {
   ...
   */
  private List<Kcp93V05TierLimitData> mValueObject;
   ...
   */
  public Kcp93V05TierLimitDataWrapperBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final ICobolComplexBinding complexItemBinding )
    {

    super( bindingName, fieldName, Kcp93V05TierLimitData.class, null, parentBinding, complexItemBinding );
    setMinOccurs( 5 );
    setMaxOccurs( 5 );
    }
  ...
  public void createValueObject() throws HostException
    {
    mValueObject = new ArrayList<Kcp93V05TierLimitData>();
    }
  ...
  public void setItemValue( final int index ) throws HostException
    ...
    if( index < mValueObject.size() )
      ...
      if( _log.isDebugEnabled() )
        {
        _log.debug( "Getting value from item " + index + " of Value object property " + "List < Kcp93V05TierLimitData >" + " value=" + mValueObject.get( index ) );
        }
  ...
  public void addPropertyValue( final int index ) throws HostException
    ...
    mValueObject.add( (Kcp93V05TierLimitData) getComplexItemBinding().
      getObjectValue( Kcp93V05TierLimitData.class ) );
    }
  ...
  public void setObjectList( final List<?> list )
    {
    mValueObject = (List<Kcp93V05TierLimitData>) list;
    }
  ...
  public void setObjectValue( final Object value ) throws HostException
    ...
    if( value instanceof List )
      ...
      if( item.getClass().equals( Kcp93V05TierLimitData.class ) )
        {
        mValueObject = (List<Kcp93V05TierLimitData>) value;
        return;
        }
      }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Kcp93V05TierLimitData> getKcp93V05TierLimitData() throws HostException
    {
    return (List<Kcp93V05TierLimitData>) getObjectValue( Kcp93V05TierLimitData.class );
    }
