...
public class Kcp17V05AccAddressesTransformers extends AbstractTransformers
  ...
  public Kcp17V05AccAddressesTransformers()
    {
    super( new Kcp17V05AccAddressesJavaToHostTransformer(),
      new Kcp17V05AccAddressesHostToJavaTransformer() );
    }
   ...
   */
  public Kcp17V05AccAddresses toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp17V05AccAddresses toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public Kcp17V05AccAddresses toJava( final byte[] hostData, final int offset,
