 ...
 */
public class Kcp07V05BalTabBinding extends CComplexBinding
  {
   ...
   *                    complex element
   */
  public Kcp07V05BalTabBinding( final Kcp07V05BalTab valueObject )
    {
   ...
   */
  public Kcp07V05BalTabBinding( final String bindingName, final String fieldName, final ICobolComplexBinding parentBinding, final Kcp07V05BalTab valueObject )
    {
  ...
  private void initChildren()
    ...
    _kcp07V05BalIdent = BF.createPackedDecimalBinding( "Kcp07V05BalIdent", "Kcp07V05BalIdent", Short.class, this );
    ...
    _kcp07V05Bal = BF.createPackedDecimalBinding( "Kcp07V05Bal", "Kcp07V05Bal", BigDecimal.class, this );
  ...
  public void setChildrenValues() throws HostException
    ...
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp07V05BalIdent" + " value=" + mValueObject.getKcp07V05BalIdent() );
      }
    _kcp07V05BalIdent.setObjectValue( mValueObject.getKcp07V05BalIdent() );
        /* Get Value object property _kcp07V05Bal */
    if( _log.isDebugEnabled() )
      {
      _log.debug( "Getting value from Value object property " + "_kcp07V05Bal" + " value=" + mValueObject.getKcp07V05Bal() );
      }
