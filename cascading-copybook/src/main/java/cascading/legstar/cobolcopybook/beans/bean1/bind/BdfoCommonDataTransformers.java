...
public class BdfoCommonDataTransformers extends AbstractTransformers
  ...
  public BdfoCommonDataTransformers()
    {
    super( new BdfoCommonDataJavaToHostTransformer(),
      new BdfoCommonDataHostToJavaTransformer() );
    }
   ...
   */
  public BdfoCommonData toJava( final byte[] hostData, final String hostCharset )
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoCommonData toJava( final byte[] hostData )
    throws HostTransformException
    {
   ...
   * @throws HostTransformException if transformation fails
   */
  public BdfoCommonData toJava( final byte[] hostData, final int offset,
