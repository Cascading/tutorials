...
public class Cob2FieldsProcessor {
    ...
    private static Logger log = LoggerFactory
            .getLogger(Cob2FieldsProcessor.class);
    ...
    public void processElement(final XmlSchema schema,
            ...
            final String label) throws Cob2FieldsException {
    ...
    public Type getJavaType(final XmlSchemaSimpleType xsdType) {
        ...
        if (restriction != null && restriction.getBaseTypeName() != null) {
            ...
            if (xsdTypeName.equals(Constants.XSD_STRING)) {
                ...
                log.warn("Unable to derive java type from "
    ...
    public Fields getFields() {
        return new Fields(fieldNames.toArray(new String[fieldNames.size()]),
                fieldTypes.toArray(new Type[fieldTypes.size()]));
    }
